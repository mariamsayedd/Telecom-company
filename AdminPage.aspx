...
during the last year along with the total amount of earned points.</h5>
        ...
        <div class="container mt-5">
            <asp:h3 ID="outputText" runat="server" CssClass="table table-striped table-bordered table-hover">
            </asp:h3>
        </div>
...
input plan id. </h5>
                ...
                <div class="card-body d-grid">
                    ...
                    <div class="mb-1">
                        <%-- <asp:Label runat="server" Text="Enter Mobile Number" CssClass="form-label"></asp:Label> --%>
                        <asp:TextBox ID="TextBox_PlanID" runat="server" CssClass="form-control" placeholder="Enter Plan ID" TextMode="Date"></asp:TextBox>
                    </div>
                        <div class="d-grid col-md-3 mx-auto">
                            ...
                            <div class="container mt-5">
    <asp:h3 ID="cashback_H1" runat="server" CssClass="table table-striped table-bordered table-hover">
    </asp:h3>
</div>
...
a certain input duration </h5>
    ...
    <asp:TextBox ID="end_date_avgSentTrans" runat="server" CssClass="form-control" placeholder="Enter endDate" TextMode="Date"></asp:TextBox>
              ...
              <div class="container mt-5">
    <asp:h3 ID="avg_Sent_Trans_h3" runat="server" CssClass="table table-striped table-bordered table-hover">
    </asp:h3>
</div>
        ...
        <div class="col-md-4">
            <div class="card shadow">
                ...
                <div class="card-body d-grid">
                        <div class="mb-3">
                            <%-- <asp:Label runat="server" Text="Enter Mobile Number" CssClass="form-label"></asp:Label> --%>
                            <asp:TextBox ID="MobileNumber_isLinked" runat="server" CssClass="form-control" placeholder="Enter mobile number " TextMode="Date"></asp:TextBox>
                        </div>
                        <div class="d-grid col-md-3 mx-auto">
                      ...
                      <div class="container mt-5">
    <asp:h3 ID=" isLinked" runat="server" CssClass="table table-striped table-bordered table-hover">
    </asp:h3>
</div>
...
that it should have. 
                ...
                <div class="card-body d-grid">
                        <div class="mb-3">
                            <%-- <asp:Label runat="server" Text="Enter Mobile Number" CssClass="form-label"></asp:Label> --%>
                            <asp:TextBox ID="MobileNo_update" runat="server" CssClass="form-control" placeholder="Enter mobile number " TextMode="Date"></asp:TextBox>
                        </div>
                        <div class="d-grid col-md-3 mx-auto">
                      ...
                      <div class="container mt-5">
    <asp:h3 ID="H1" runat="server" CssClass="table table-striped table-bordered table-hover">
    </asp:h3>
</div>
